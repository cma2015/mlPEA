...
## How to cite mlPEA
- Yang, J., Song, M., Bu, Y., Zhao, H., Liu, C., Zhang, T., Zhang, C., Xu, S., & Ma, C. (2024). Machine learning–augmented m<sup>6</sup>A-Seq analysis without a reference genome, Briefings in Bioinformatics, Volume 26, Issue 3, May 2025, bbaf235, https://doi.org/10.1093/bib/bbaf235
